      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        >
          {categories.map((cat) => {
            ...
            const surface = image.startsWith("bg-") || image.startsWith("from-")
              ? image
            ...
            return (
              ...
              >
                <div
                  className={`flex h-16 w-16 items-center justify-center overflow-hidden rounded-full text-2xl font-bold text-primary/60 transition-transform group-hover:scale-105 sm:h-20 sm:w-20 ${remote ? "bg-slate-100" : surface}`}
                  style={
                    remote
                      ? {
